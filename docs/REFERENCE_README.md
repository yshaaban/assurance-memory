> Reference guide imported from 1.0.0. Commands run from the repository root. Original validation/version statements are historical; consult VALIDATION_1_1.md for current results.
