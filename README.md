...
The [1.5 validation report](docs/VALIDATION_1_5.md) records source-observation migration, real database/restart checks, full-project handoff controls and the fresh paired study. The [independent retrieval check](docs/RETRIEVAL_1_5.md) improved owner recall but lost one intentional counterexample; it does not establish a uniformly better investigation.
